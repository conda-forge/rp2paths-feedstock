...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rp2paths-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14689&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rp2paths-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rp2paths` can be installed with:

```
conda install rp2paths
```

It is possible to list all of the versions of `rp2paths` available on your platform with:
